...
/**
 * Logs {@code SESSION_TIMEOUT} events when an HTTP session expires. Explicit logouts are skipped
 * because {@link LogoutListener} already records them.
 */
@Component
...
public class SessionTimeoutListener implements HttpSessionListener {
	...
	public void sessionDestroyed(HttpSessionEvent event) {
		...
		try {
			...
			auditService.logSecurityEvent(AuditSecurityEventType.SESSION_TIMEOUT, username, user.getUuid(), null, null,
			    session.getId(), null);
		}
		catch (Exception e) {
