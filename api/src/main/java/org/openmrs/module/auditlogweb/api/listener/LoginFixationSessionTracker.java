...
/**
 * It tracks pre-login session ids that are destroyed during login session fixation protection, so
 * those destroys are not audited as real session timeouts.
 */
public final class LoginFixationSessionTracker {
